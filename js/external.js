...
let BBprom = prompt( `ow many days did you rent out brotherbear?`)
...
let gogprom = prompt(`how much does google pay per hour`)

alert(`${gogprom} the crrect answer is ${googlePerHour}`)
...
alert(`${facehorworkpro} shoul;d match ${facebookHoursWork}`)
