...
// const isPalindrome =(name)=> {
//     if(typeof name === "number" || Array.isArray(name) || !name){
//         return false
//     }
//     let splitname = name.split("")
//     let revname = splitname.reverse()
//     let joinname = revname.join("")
//     if(joinname.toLowerCase() === name.toLowerCase()){
//         return true
//
//         }else if(joinname === " "){
//             return true
...
const getHighestNumber =(num1, num2, num3)=> {
    if (isNaN(num2) || typeof num2 === "boolean" || typeof num2 === "string") {
        return false
    }

    let inputs = [num1, num2, num3]
...
console.log(getHighestNumber(-10, 1, 5))